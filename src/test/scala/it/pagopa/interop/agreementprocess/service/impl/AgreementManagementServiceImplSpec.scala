...
import it.pagopa.interop.agreementmanagement.client.model.{VerifiedAttribute, VerifiedAttributeSeed}
import it.pagopa.interop.agreementprocess.SpecHelper
import it.pagopa.interop.agreementprocess.model.AgreementPayload
import it.pagopa.interop.agreementprocess.service.AgreementManagementService
